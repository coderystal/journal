...
## 20251005 - question deck
### cookies
* setting cookies in one statement doesn't work. setting cookies one at a time works
* failed `document.cookie = "key1=val1; key2=val2;`
* passed `document.cookie = "key1=val1"; document.cookie = "key2=val2";`
* read cookies
```
...
let val1 = cookies.key1
```
* context: deck+question cookie combo
